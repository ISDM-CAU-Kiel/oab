...
from oab.data.abstract_classes import AbstractClassificationDataset
from oab.data.utils import _read_from_yaml, _get_dataset_dict
...
class ClassificationDataset(AbstractClassificationDataset):
    ...
    def transform_categorical_to_one_hot(self, cols_to_onehot: List[int]) -> None:
        ...
        #here edited 
        if operation_record not in self.operations_performed:
