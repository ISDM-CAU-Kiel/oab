...
def get_tabular_dataset_names(datasets_yaml_path:str=Path(os.getcwd()).parent/"oab"/"data"/"datasets.yaml"):
...
def load_own_tabular_dataset(dataset_name:str,dataset_format:str="csv",class_labels:str="last",
                       ...
                       ,datasets_yaml_path:str=Path(os.getcwd()).parent/"oab"/"data"/"datasets.yaml"
...
def data_from_recipe(info_type,file1,dataset_folder:str=Path(os.getcwd()).parent/"notebooks"/"benchmark_tabular"/"datasets",datasets_yaml_path:str=Path(os.getcwd()).parent/"oab"/"data"/"datasets.yaml"):
